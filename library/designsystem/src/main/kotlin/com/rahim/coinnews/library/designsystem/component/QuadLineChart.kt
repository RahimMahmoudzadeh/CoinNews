...
import com.rahim.coinnews.library.designsystem.theme.graphColor
import com.rahim.coinnews.library.designsystem.theme.lightGraphColor
...
fun QuadLineChart(
    ...
    data: PersistentList<Pair<Long, Double>>,
) {
    val spacing =
